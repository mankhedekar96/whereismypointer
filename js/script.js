...
function getMousePosition(event) {
  ...
  var posX = Math.floor((leftPercentage * 40) / 100);
  var posY = Math.floor((topPercentage * 45) / 100);

  var centerPosX = Math.floor((leftPercentage * 15) / 100);
  var centerPosY = Math.floor((topPercentage * 15) / 100);
  ...
  $(".eye-ball-center").css(
    "transform",
    "translate( " + centerPosX + "px, " + centerPosY + "px )"
  );
